...
TUNNEL_NAME="openssh-tunnel"
DOMAIN="openssh.tokopawon.id"
PORT="22"
USER_CONFIG_DIR="$HOME/.cloudflared"
SYSTEM_CONFIG_DIR="/etc/cloudflared"

echo "=== Cloudflare Tunnel Setup for OpenSSH ==="
echo "Domain: $DOMAIN"
echo "Port:   $PORT"
echo ""
...
echo ""
echo "=== Setup Complete! ==="
echo "SSH Tunnel:  https://$DOMAIN"
echo ""
echo "Connect via SSH using cloudflared:"
echo "  cloudflared access ssh --hostname $DOMAIN"
echo ""
echo "Or add to ~/.ssh/config:"
echo "  Host openssh-tunnel"
echo "    ProxyCommand cloudflared access ssh --hostname $DOMAIN"
